...
const DEFAULT_SIGNALS_LOOKBACK_DAYS = 7  // v15: 7-day board expiry
const DEFAULT_SIGNALS_MIN_STRENGTH = 35

const DEFAULT_TICKER_SCORES_LIMIT = 100
const DEFAULT_TICKER_SCORES_PTR_LOOKBACK_DAYS = 60
const DEFAULT_TICKER_SCORES_PTR_RECENT_DAYS = 14
const DEFAULT_TICKER_SCORES_MIN_COMBINED_SCORE = 72  // v15: higher quality bar

const DEFAULT_FINAL_CANDIDATES_LIMIT = 20  // v15: tighter, more conviction
const DEFAULT_FINAL_CANDIDATES_TARGET_MIN = 10
